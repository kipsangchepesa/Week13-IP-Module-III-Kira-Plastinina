...
# Training the model using Learning vector quantification
...
# As seen from the correlation matrix the male variable has a high correlation with other variables and this has not been hidden from the feature importance sect .Internet usage is the biggest influencers of add clicks. 
```
## Training the model
...
## Predicting
```{r}
# 700 samples have been used and the models training accuracy stated at 96 percent. Looking at its behavior with new data
...
# This model is operating at 97 % accuracy, the number of miss classified classes being 7 in total. Tuning is necessary for this model.
```
